...
const badges = [
  ...
  },
  {
    ...
    boom: '我在开会你在清单狂飙！再这样你要变成巫师 CEO 了！'
  },
  {
    id: 107,
    key: 'goaltracker',
  ...
  /* ===== 运动类 ===== */
  {
    ...
    cond: '连续3天完成一次 30 分钟以上的 Boxing 健身。（可与 RingFit 相隔进行）',
  ...
  },
  {
    ...
    zh: 'RingFit 勇者',
    cat: 'Sports',
    desc: '以魔法圆环作剑，挑战关卡、消灭肥嘟嘟怪！专为 RingFit 闯关而设的勇气徽章。',
    cond: '连续3天完成挑战 RingFit。（可与 Boxing 相隔进行）',
  ...
  },
  {
    ...
    zh: '创意炼金师',
    cat: 'Study',
    desc: '创意是最强大的魔法，能把无聊变成奇迹。奖励给主动创作的魔法师。',
    cond: '独立完成 science notebook 的一个话题完整作品（绘画、标记、Canva 介绍等）。',
  ...
  },
  {
    ...
    cond: '完成一次困难挑战，例如高阶指定学习任务（UOI / Math 等）。',
  ...
  },
  {
    ...
    cond: '连续专注完成一项任务超出预设时间（如连续 40 分钟写作 / 练习不分心）。',
  ...
  },
  {
    ...
    zh: '闪电勋章',
    cat: 'Study',
    desc: '授予像闪电一样迅捷的小巫师——不仅完成了任务，还大幅提前时间线！',
    cond: '在无人提醒的情况下，提前 2 小时以上独立完成指定任务。',
    boom: '你比我施的预言咒还早！差点以为你用时光转换器作弊！'
  },
  {
    id: 308,
    key: 'heartofcourage',
    ...
    zh: '勇气之心',
    cat: 'Study',
    desc: '面对恐惧仍然前行的小巫师才能获得这枚稀有徽章！',
    cond: '完成一件令自己害怕但仍鼓起勇气面对的重要任务（当众发言、表达感受等）。',
    boom: '你比我打败三头蛇时还勇敢！如果勇气是魔药，你就是 S‑级限量版！'
  }
];
